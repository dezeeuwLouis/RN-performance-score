...
import { MAX_SCORE, DROPPED_FRAME_RATIO, UI_WEIGHT, JS_WEIGHT, AVG_SEVERITY_WEIGHT, WORST_SEVERITY_WEIGHT } from "../types.js";
/**
 ...
 */
export function calculateScore(samples, targetFps) {
  if (samples.length === 0) {
    return {
      score: 0,
      avgJsFps: 0,
